...
#' prior. Version 2 refers to $\beta^o + \bm P \beta^a \sim N(\psi m_\alpha, \psi^2 {\bm S}_\alpha / \phi)$
#' (contrast to Version 1, the original SAB from Boonstra and Barbaro,
#' which uses $\beta^o + \bm P \beta^a \sim N(m_\alpha, \eta {\bm S}_\alpha / \phi)$)
#'
